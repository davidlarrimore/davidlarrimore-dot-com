        ...
        <div className="px-4 mx-auto max-w-screen-xl">
          ...
          <div className="mb-12 text-center">
            ...
            <a 
              ...
              download="DavidLarrimore-Resume.pdf"
            >
              Download Resume PDF
          ...
          <div className="grid gap-12 md:gap-16">
            ...
            <section className="resume-section bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
              <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                <div>
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">DAVID LARRIMORE</h2>
                  <p className="text-xl text-gray-600 dark:text-gray-300">Technologist / Senior Executive / Leader</p>
                </div>
                <div className="mt-4 md:mt-0 text-right">
                  <p className="text-gray-700 dark:text-gray-300">davidlarrimore@gmail.com</p>
                  <a 
                    href="http://linkedin.com/in/davidlarrimore" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-primary hover:underline"
                  >
                    linkedin.com/in/davidlarrimore
                  </a>
                </div>
              </div>
            </section>
            ...
            <section className="resume-section bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                Senior Executive Technologist with 15+ years of expertise in IT modernization, AI strategy, cloud computing, and
                enterprise technology transformation. Proven ability to develop and implement cutting-edge technology solutions,
                optimize IT investments, and drive innovation at scale. Passionate about AI, Product Development, and Human Centered
                Design.
              </p>
            </section>
            ...
            {/* Technical Expertise */}
            <section className="resume-section bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">TECHNICAL EXPERTISE</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">AI & Machine Learning</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    AI governance, generative AI, large language models (LLMs), Responsible Use, Facial Recognition Technology (FRT), AI automation
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">Cloud Computing</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    AWS, Microsoft Azure, multi-cloud architecture, cloud security, cloud cost optimization
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">Software Development & Engineering</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    Open Source, Python, Java, Node.js, Apex (SFDC), SQL, API development, database architecture, full-stack development
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">Agile & DevSecOps</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    Scaled Agile Framework (SAFe), CI/CD pipelines, test automation, Kubernetes, Docker, Infrastructure as Code (IaC)
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">Data Architecture & Analytics</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    Big Data (Hadoop, Hortonworks), Business Intelligence (Tableau, MicroStrategy), Data Warehousing, SQL, MongoDB
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-primary mb-2">IT Governance & Enterprise Architecture</h3>
                  <p className="text-gray-700 dark:text-gray-300">
                    Technical reference models, IT portfolio management, Automated Governance, IT acquisition strategy
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="resume-section bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
              ...
              <div className="mb-10">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Previous Positions</h3>
            ...
            {/* Awards */}
            <section className="resume-section bg-white dark:bg-gray-800 rounded-xl p-8 shadow-md">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">RECENT AWARDS</h2>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
                ...
                <li>Washington Exec, Pinnacle Cloud Executive of the Year, 2024</li>
